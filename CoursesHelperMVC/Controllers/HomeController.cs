        ...
        if (User.IsInRole("Coordinator"))
        {
            return new HomeViewModel
            {
                ...
                [
                    ...
                    new HomeOptionViewModel { Category = "Certification", Title = "Certification Progress", Description = "Track trainee completion against certification requirements.", Controller = "TraineeCertifications", Action = "Progress" },
                    new HomeOptionViewModel { Category = "Certification", Title = "Trainee Qualifications", Description = "Review course qualifications earned by trainees.", Controller = "TraineeQualifications", Action = "Index" },
